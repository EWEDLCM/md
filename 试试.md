...
至此，我们完成了下载器的设置。
#### 5. 填写 TMDB 的 API
在浏览器打开 [The Movie Database (TMDb)](https://www.themoviedb.org/) 进行注册，和常规的注册一样，完成后会发送一封邮件到你的邮箱，在邮箱验证后即可回到原yemian登录，此处不做过多赘述。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNzg4MTU2OTAsMTYzMDkyNDUzMV19
-->